...
writeHtml('<div  id="swarupGallery" class="images_thumb">');
writeHtml('<ul >');
foreach ($sortedImages as $image) {
    ...
    writeHtml('<li  id="swarupGallery"><a name="' . $image . '" href="' . $image . '">');
